...
var AppController = function () {
    function AppController(httpService, linkService) {
    ...
    _createClass(AppController, [{
        ...
        value: function $onInit() {
            ...
            this.httpService.init(this.config.ajax);
            this.linkService.init(this.config.page);
        }
    }, {
        key: 'valueUpdated',
        value: function valueUpdated(_ref) {
...
AppController.$inject = ['httpService', 'linkService'];
...
var _angularTooltips = require('angular-tooltips');

var _angularTooltips2 = _interopRequireDefault(_angularTooltips);
...
var root = _angular2.default.module('app', [_angularSanitize2.default, _angularTooltips2.default, _components2.default, _components4.default, _services2.default]).config(['tooltipsConfProvider', function (tooltipsConfProvider) {
...
},{"./app.component":1,"./common/components":8,"./components/components":27,"./services":51,"angular":60,"angular-sanitize":56,"angular-tooltips":58}],4:[function(require,module,exports){
'use strict';
...
var Controller = function () {
    function Controller($timeout, httpService) {
    ...
    _createClass(Controller, [{
        ...
        value: function $onChanges(changes) {
            ...
            if (changes.settings) {
                ...
                this.values = Object.keys(this.settings).reduce(function (prev, key) {
                    return Object.assign(prev, _defineProperty({}, key, _this.settings[key].value));
                }, {});
            }
        }
    }, {
        ...
        value: function update(_ref) {
            ...
            this.settings[key] = Object.assign({}, this.settings[key], { value: this.values[key] });
        }
    }]);
...
Controller.$inject = ['$timeout', 'httpService'];
...
var _buttonPreview = require('./button-preview.controller');

var _buttonPreview2 = _interopRequireDefault(_buttonPreview);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ButtonPreviewComponent = {
    bindings: {
        networks: '<',
        buttonShape: '<',
        buttonSize: '<'
    },
    controller: _buttonPreview2.default,
    template: '<div ng-class="[$ctrl.themeClass, $ctrl.buttonSizeClass]" class="frizzly-button-container">\n            <a href="#" ng-repeat="key in $ctrl.networks" class="frizzly-button frizzly-{{ key }}">\n                <i class="fa fa-fw {{ $ctrl.getNetworkClass(key) }}"></i>\n            </a>\n        </div>'
};

exports.default = ButtonPreviewComponent;

},{"./button-preview.controller":6}],6:[function(require,module,exports){
'use strict';
...
var ButtonPreviewController = function () {
    function ButtonPreviewController() {
        _classCallCheck(this, ButtonPreviewController);
    }

    _createClass(ButtonPreviewController, [{
        key: '$onChanges',
        value: function $onChanges(changes) {
            if (changes.networks) this.networks = changes.networks.currentValue;
            if (changes.buttonShape) {
                this.buttonShape = changes.buttonShape.currentValue;
                this.themeClass = 'frizzly-theme-' + this.buttonShape;
            }
            if (changes.buttonSize) {
                this.buttonSize = changes.buttonSize.currentValue;
                this.buttonSizeClass = 'frizzly-button-size-' + this.buttonSize;
            }
        }
    }, {
        key: 'getNetworkClass',
        value: function getNetworkClass(key) {
            switch (key) {
                case 'email':
    ...
    return ButtonPreviewController;
}();

exports.default = ButtonPreviewController;
...
var _buttonPreview = require('./button-preview.component');

var _buttonPreview2 = _interopRequireDefault(_buttonPreview);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var buttonPreview = _angular2.default.module('app.common.buttonPreview', []).component('buttonPreview', _buttonPreview2.default).name;

exports.default = buttonPreview;

},{"./button-preview.component":5,"angular":60}],8:[function(require,module,exports){
'use strict';
...
var _buttonPreview = require('./button-preview');

var _buttonPreview2 = _interopRequireDefault(_buttonPreview);

var _networkSelect = require('./network-select');
...
var components = _angular2.default.module('app.common', [_buttonPreview2.default, _networkSelect2.default, _share2.default]).name;

exports.default = components;

},{"./button-preview":7,"./network-select":9,"./share":24,"angular":60}],9:[function(require,module,exports){
'use strict';
...
var _networkSelect = require('./network-select.component');

var _networkSelect2 = _interopRequireDefault(_networkSelect);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _module = _angular2.default.module('app.common.networkSelect', []).component('networkSelect', _networkSelect2.default).name;

exports.default = _module;

},{"./network-select.component":10,"angular":60}],10:[function(require,module,exports){
'use strict';
...
var _networkSelect = require('./network-select.controller');
...
var ButtonPreviewComponent = {
    ...
    controller: _networkSelect2.default,
    template: '\n        <input type="hidden" ng-value="$ctrl.value" name="{{ ::$ctrl.args.key }}" /> \n        <button type="button" ng-click="$ctrl.showModal();" class="button">{{ ::$ctrl.args.modalTitle }}</button>\n        <modal show=\'$ctrl.modalVisible\' width=\'500px\' height=\'500px\' title=\'{{ $ctrl.args.modalTitle }}\' on-close="$ctrl.onModalClose($event);">\n            <editor-sortable-select args="$ctrl.args" on-update="$ctrl.update($event)"></editor-sortable-select>\n            <p class="description" ng-bind-html="$ctrl.args.modalDescription"></p>\n            <p style="text-align: center;">\n                <button type="button" ng-click="$ctrl.confirmModal();" class="button button-primary">{{ ::$ctrl.args.modalConfirm }}</button>\n            </p>\n        </modal>'
};

exports.default = ButtonPreviewComponent;

},{"./network-select.controller":11}],11:[function(require,module,exports){
'use strict';
...
var Controller = function () {
    ...
    _createClass(Controller, [{
        key: '$onChanges',
        value: function $onChanges(changes) {
            if (changes.args) this.args = _angular2.default.copy(changes.args.currentValue);
        }
    }, {
        key: 'confirmModal',
        value: function confirmModal($event) {
            this.onUpdate({ $event: { key: this.args.key, value: this.value } });
            this.onModalClose();
        }
    }, {
        key: 'onModalClose',
        ...
        value: function showModal($event) {
            this.args = _angular2.default.extend({}, this.args);
...
},{"angular":60}],12:[function(require,module,exports){
'use strict';
...
var ButtonStyleDirective = function () {
    ...
    return ButtonStyleDirective;
}();

exports.default = ButtonStyleDirective;
...
var Component = {
    ...
    template: '\n    <p ng-bind-html="$ctrl.i18n.module_description"></p>\n    <h2>{{ ::$ctrl.i18n.visual_header }}</h2>\n    <table class="form-table">\n        <tbody>\n            <tr>\n                <th>{{ ::$ctrl.settings.networks.label }}</th>\n                <td>\n                    <button-preview style="margin-left: 15px;"\n                        networks = "$ctrl.values.networks"\n                        button-shape = "$ctrl.values.button_shape"\n                        button-size = "$ctrl.values.button_size">\n                    </button-preview>\n                    <p>\n                        <network-select args="$ctrl.settings.networks" on-update="$ctrl.update($event)"></network-select>\n                    </p>\n                    <p class="description" ng-bind-html="$ctrl.settings.networks.description"></p>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ $ctrl.i18n.button_style_title }}</th>\n                <td>\n                    <content-button-style\n                        size="$ctrl.settings.button_size"\n                        shape="$ctrl.settings.button_shape"\n                        align="$ctrl.settings.align"\n                        template="$ctrl.i18n.button_style_template"\n                        update="$ctrl.update($event)">\n                    </content-button-style>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ $ctrl.settings.where.label }}</th>\n                <td>\n                    <editor-select args="$ctrl.settings.where" on-update="$ctrl.update($event)"></editor-select>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ $ctrl.settings.pinterest_behavior.label }}</th>\n                <td>\n                    <editor-select args="$ctrl.settings.pinterest_behavior" on-update="$ctrl.update($event)"></editor-select>\n                    <p class="description" ng-bind-html="$ctrl.settings.pinterest_behavior.description"></p>\n                </td>\n            </tr>\n        </tbody>\n    </table>\n    <h2>{{ ::$ctrl.i18n.selection_header }}</h2>\n    <table class="form-table">\n        <tbody>\n            <tr>\n                <th>{{ ::$ctrl.i18n.where_title }}</th>\n                <td>\n                <p>\n                    <label for="enabled_on">{{ ::$ctrl.settings.enabled_on.label }}:</label><br/>\n                    <editor-textarea args="$ctrl.settings.enabled_on" on-update="$ctrl.update($event)"></editor-textarea>\n                </p>\n                <p>\n                    <label for="disabled_on">{{ ::$ctrl.settings.disabled_on.label }}:</label><br/>\n                    <editor-textarea args="$ctrl.settings.disabled_on" on-update="$ctrl.update($event)"></editor-textarea>\n                </p>\n                <p class="description" ng-bind-html="$ctrl.i18n.where_description"></p>\n                </td>\n            </tr>\n        </tbody>\n    </table>\n  '
};

exports.default = Component;

},{"./../../base.controller":4}],14:[function(require,module,exports){
'use strict';
...
var _buttonStyle = require('./buttonStyle.directive');
...
},{"./buttonStyle.directive":12,"./content.component":13,"angular":60}],15:[function(require,module,exports){
'use strict';
...
var Component = {
    ...
    controller: _base2.default,
    template: '\n    <h2>{{ ::$ctrl.i18n.modules_title }}</h2>\n    <table class="form-table">\n        <tbody>\n            <tr>\n                <th>{{ $ctrl.i18n.active_modules_title }}</th>\n                <td id="frizzly_general_active_modules">\n                    <editor-checkbox args="$ctrl.settings.active_image" on-update="$ctrl.update($event)" add-br="false"></editor-checkbox>\n                    <a class="frizzly-settings-link" ng-href="{{ ::$ctrl.i18n.image_module_href }}" ng-bind-html="$ctrl.i18n.module_configuration_link"></a><br/>\n                    <editor-checkbox args="$ctrl.settings.active_content" on-update="$ctrl.update($event)" add-br="false"></editor-checkbox>\n                    <a class="frizzly-settings-link" ng-href="{{ ::$ctrl.i18n.content_module_href }}" ng-bind-html="$ctrl.i18n.module_configuration_link"></a><br/>\n                </td>\n            </tr>\n        </tbody>\n    </table>\n    <h2>{{ ::$ctrl.i18n.networks_title }}</h2>\n    <table class="form-table">\n        <tbody>\n            <tr>\n                <th>{{ $ctrl.settings.twitter_handle.label }}</th>\n                <td>\n                    <editor-text args="$ctrl.settings.twitter_handle" on-update="$ctrl.update($event)"></editor-text>\n                    <p class="description" ng-bind-html="$ctrl.settings.twitter_handle.description"></p>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ $ctrl.settings.add_handle_to_tweets.label }}</th>\n                <td>\n                    <editor-checkbox args="$ctrl.settings.add_handle_to_tweets" on-update="$ctrl.update($event)"></editor-checkbox>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ $ctrl.settings.pinterest_source.label }}</th>\n                <td>\n                    <editor-sortable-select args="$ctrl.settings.pinterest_source" on-update="$ctrl.update($event)"></editor-sortable-select>\n                    <p class="description" ng-bind-html="$ctrl.settings.pinterest_source.description"></p>\n                </td>\n            </tr>\n        </tbody>\n    </table>\n    <h2>{{ ::$ctrl.i18n.meta_title }}</h2>\n    <table class="form-table">\n        <tbody>\n            <tr>\n                <th>{{ $ctrl.i18n.meta_data_label }}</th>\n                <td>\n                    <editor-checkbox args="$ctrl.settings.meta_open_graph" on-update="$ctrl.update($event)"></editor-checkbox>\n                    <twitter-meta \n                        meta="$ctrl.settings.meta_twitter"\n                        card="$ctrl.settings.meta_twitter_card_type" \n                        template="$ctrl.i18n.meta_twitter_template"\n                        on-update="$ctrl.update($event)"></twitter-meta>\n                    <p class="description" ng-bind-html="$ctrl.i18n.meta_data_description"></p> \n                </td>\n            </tr>\n        </tbody>\n    </table>\n  '
};

exports.default = Component;

},{"./../../base.controller":4}],16:[function(require,module,exports){
'use strict';
...
var _general = require('./general.component');

var _general2 = _interopRequireDefault(_general);

var _twitterMeta = require('./twitterMeta.directive');

var _twitterMeta2 = _interopRequireDefault(_twitterMeta);
...
},{"./general.component":15,"./twitterMeta.directive":17,"angular":60}],17:[function(require,module,exports){
'use strict';
...
var TwitterMetaDirective = function () {
    ...
    return TwitterMetaDirective;
}();

exports.default = TwitterMetaDirective;
...
var Component = {
    ...
    controller: _image2.default,
    template: '\n    <p ng-bind-html="$ctrl.i18n.module_description"></p>\n    <h2>{{ ::$ctrl.i18n.visual_header }}</h2>\n    <table class="form-table">\n        <tbody>\n            <tr>\n                <th>{{ ::$ctrl.settings.networks.label }}</th>\n                <td>\n                    <button-preview style="margin-left: 15px;"\n                        networks = "$ctrl.values.networks"\n                        button-shape = "$ctrl.values.button_shape"\n                        button-size = "$ctrl.values.button_size">\n                    </button-preview>\n                    <p>\n                        <network-select args="$ctrl.settings.networks" on-update="$ctrl.update($event)"></network-select>\n                    </p>\n                    <p class="description" ng-bind-html="$ctrl.settings.networks.description"></p>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ $ctrl.i18n.button_style_title }}</th>\n                <td>\n                    <image-button-style size="$ctrl.settings.button_size" shape="$ctrl.settings.button_shape" show="$ctrl.settings.show"\n                        template="$ctrl.i18n.button_style_template" update="$ctrl.update($event)"></image-button-style>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ ::$ctrl.settings.button_position.label }}</th>\n                <td>\n                    <table class="frizzly-no-padding">\n                    <tr><td></td>\n                        <td><editor-number ng-disabled="!$ctrl.marginAvailability.top" args="$ctrl.settings.button_margin_top" on-update="$ctrl.update($event)"></editor-number> px</td>\n                        <td></td></tr>\n                    <tr>\n                        <td><editor-number ng-disabled="!$ctrl.marginAvailability.left" args="$ctrl.settings.button_margin_left" on-update="$ctrl.update($event)"></editor-number> px</td>\n                        <td>\n                            <editor-select args="$ctrl.settings.button_position" on-update="$ctrl.update($event)"></editor-select>\n                        </td>\n                        <td><editor-number ng-disabled="!$ctrl.marginAvailability.right" args="$ctrl.settings.button_margin_right" on-update="$ctrl.update($event)"></editor-number> px</td>\n                    </tr>\n                    <tr><td></td><td><editor-number ng-disabled="!$ctrl.marginAvailability.bottom" args="$ctrl.settings.button_margin_bottom" on-update="$ctrl.update($event)"></editor-number>px</td><td></td></tr>\n                    </table>\n                </td>\n            </tr>\n        </tbody>\n    </table>\n    <h2>{{ ::$ctrl.i18n.selection_header }}</h2>\n    <table class="form-table">\n        <tbody>\n            <tr>\n                <th><label for="image_selector">{{ ::$ctrl.settings.image_selector.label }}</label></th>\n                <td>\n                    <editor-text args="$ctrl.settings.image_selector" on-update="$ctrl.update($event)"></editor-text>\n                    <p class="description">{{ ::$ctrl.settings.image_selector.description }}</p>\n                    <p>\n                        <image-classes discriminator="$ctrl.settings.image_classes_positive" classes="$ctrl.settings.image_classes"\n                            template="$ctrl.i18n.image_classes_template" update="$ctrl.update($event)"></image-classes>\n                    </p>\n                    <p class="description">{{ ::$ctrl.settings.image_classes.description }}</p>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ ::$ctrl.i18n.min_resolution_title }}</th>\n                <td>\n                    <p>\n                        <resolution height="$ctrl.settings.desktop_min_height" width="$ctrl.settings.desktop_min_width"\n                            update="$ctrl.update($event)" template="$ctrl.i18n.min_resolution_template">\n                        </resolution>\n                    </p>\n                    <p class="description">{{ ::$ctrl.i18n.min_resolution_description }}</p>\n                </td>\n            </tr>\n            <tr>\n                <th>{{ ::$ctrl.i18n.where_title }}</th>\n                <td>\n                <p>\n                    <label for="enabled_on">{{ ::$ctrl.settings.enabled_on.label }}:</label><br/>\n                    <editor-textarea args="$ctrl.settings.enabled_on" on-update="$ctrl.update($event)"></editor-textarea>\n                </p>\n                <p>\n                    <label for="disabled_on">{{ ::$ctrl.settings.disabled_on.label }}:</label><br/>\n                    <editor-textarea args="$ctrl.settings.disabled_on" on-update="$ctrl.update($event)"></editor-textarea>\n                </p>\n                <p class="description" ng-bind-html="$ctrl.i18n.where_description"></p>\n                </td>\n            </tr>\n        </tbody>\n    </table>\n  '
};

exports.default = Component;

},{"./image.controller":20}],20:[function(require,module,exports){
'use strict';
...
var _baseController = require('./../../base.controller.js');
...
var ImageController = function (_Controller) {
    ...
    function ImageController() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(ImageController).apply(this, arguments));
    }

    _createClass(ImageController, [{
        key: '$onChanges',
        value: function $onChanges(changes) {
            _get(Object.getPrototypeOf(ImageController.prototype), '$onChanges', this).call(this, changes);
        ...
        value: function update(_ref) {
            ...
            _get(Object.getPrototypeOf(ImageController.prototype), 'update', this).call(this, { key: key, value: value });
...
},{"./../../base.controller.js":4}],21:[function(require,module,exports){
'use strict';
...
var ImageClassesDirective = function () {
    ...
    return ImageClassesDirective;
}();

exports.default = ImageClassesDirective;
...
var _imageClasses = require('./imageClasses.directive');

var _imageClasses2 = _interopRequireDefault(_imageClasses);
...
},{"./buttonStyle.directive":18,"./image.component":19,"./imageClasses.directive":21,"./resolution.directive":23,"angular":60}],23:[function(require,module,exports){
'use strict';
...
var _share = require('./share.component');

var _share2 = _interopRequireDefault(_share);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var share = _angular2.default.module('app.share', [_content2.default, _image2.default, _general2.default]).component('share', _share2.default).name;

exports.default = share;

},{"./content":14,"./general":16,"./image":22,"./share.component":25,"angular":60}],25:[function(require,module,exports){
'use strict';
...
var ShareComponent = {
    bindings: {},
    controller: _share2.default,
    template: '<navbar id="settings-navbar" \n        tab="$ctrl.config.tab"\n        tabs="$ctrl.config.tabs"\n        links="$ctrl.config.i18n.links"\n        page="$ctrl.config.page">\n    </navbar>\n    <status i18n="$ctrl.config.i18n.status"></status>\n    <form method="POST" action="{{ $ctrl.config.save.post_url }}">\n        <input name="{{ ::$ctrl.config.save.action }}" value="{{ ::$ctrl.config.save.nonce }}" type="hidden" />\n        <input name="{{ ::$ctrl.config.save.tab }}" value="{{ ::$ctrl.config.tab }}" type="hidden" />\n        <share-general ng-if="$ctrl.config.tab == \'general\'"\n            i18n="$ctrl.config.i18n.editor"\n            settings="$ctrl.config.settings">\n        </share-general>\n        <share-image ng-if="$ctrl.config.tab == \'image\'"\n            i18n="$ctrl.config.i18n.editor"\n            settings="$ctrl.config.settings">\n        </share-image>\n        <share-content ng-if="$ctrl.config.tab == \'content\'"\n            i18n="$ctrl.config.i18n.editor"\n            settings="$ctrl.config.settings">\n        </share-content>\n        <input type="submit" class="button button-primary" value="{{ ::$ctrl.config.save.submit }}" />    \n    </form>\n    '
};

exports.default = ShareComponent;

},{"./share.controller":26}],26:[function(require,module,exports){
'use strict';
...
var Controller = function () {
    function Controller(httpService, linkService) {
        _classCallCheck(this, Controller);
    ...
    _createClass(Controller, [{
        key: '$onInit',
        value: function $onInit() {
            this.config = window.frizzlySettings;
            this.httpService.init(this.config.ajax);
            this.linkService.init(this.config.page);
        }
    }]);
...
Controller.$inject = ['httpService', 'linkService'];
...
var components = _angular2.default.module('app.components', [_navbar2.default, _editors2.default, _modal2.default, _status2.default]).name;

exports.default = components;

},{"./editors":41,"./modal":42,"./navbar":45,"./status":47,"angular":60}],28:[function(require,module,exports){
'use strict';
...
},{"./editor.checkbox.controller":29}],29:[function(require,module,exports){
'use strict';
...
var EditorCheckboxController = function (_controller) {
    ...
    function EditorCheckboxController() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorCheckboxController).apply(this, arguments));
    }
...
},{"./editor.controller":30}],30:[function(require,module,exports){
"use strict";
...
},{"./editor.image.controller":32}],32:[function(require,module,exports){
'use strict';
...
var ImageController = function (_BaseController) {
    ...
    function ImageController($scope) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ImageController).call(this));
...
},{"./editor.controller":30}],33:[function(require,module,exports){
'use strict';
...
},{"./editor.controller":30}],34:[function(require,module,exports){
'use strict';
...
},{"./editor.select.controller":36}],36:[function(require,module,exports){
'use strict';
...
var SelectEditorController = function (_EditorController) {
    ...
    function SelectEditorController() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(SelectEditorController).apply(this, arguments));
    }

    _createClass(SelectEditorController, [{
        key: '$onChanges',
        value: function $onChanges(changes) {
            _get(Object.getPrototypeOf(SelectEditorController.prototype), '$onChanges', this).call(this, changes);
            if (changes.args) {
...
},{"./editor.controller":30}],37:[function(require,module,exports){
'use strict';
...
},{"./editor.sortableSelect.controller":38}],38:[function(require,module,exports){
"use strict";
...
var EditorTextComponent = {
    ...
    template: '<input type="text" placeholder="{{ $ctrl.args.placeholder || \'\' }}" name="{{ ::$ctrl.key }}" id="{{ $ctrl.key }}" ng-model="$ctrl.value" ng-change="$ctrl.change()" ng-class="$ctrl.class" />'
};

exports.default = EditorTextComponent;

},{"./editor.controller":30}],40:[function(require,module,exports){
'use strict';
...
},{"./editor.controller":30}],41:[function(require,module,exports){
'use strict';
...
},{"./editor.checkbox.component":28,"./editor.image.component":31,"./editor.number.component":33,"./editor.number.directive":34,"./editor.select.component":35,"./editor.sortableSelect.component":37,"./editor.text.component":39,"./editor.textarea.component":40,"angular":60}],42:[function(require,module,exports){
'use strict';
...
var modal = _angular2.default.module('modal', []).component('modal', _modal2.default).name;

exports.default = modal;

},{"./modal.component":43,"angular":60}],43:[function(require,module,exports){
'use strict';
...
var _modal = require('./modal.controller');
...
var ModalComponent = {
    ...
    template: '\n    <div class=\'frizzly-modal\' ng-show=\'$ctrl.show\'>\n        <div class=\'frizzly-modal-overlay\' ng-click=\'$ctrl.hideModal()\'></div>\n        <div class=\'frizzly-modal-dialog\' ng-style=\'$ctrl.dialogStyle\'>\n            <span class=\'frizzly-modal-title\' ng-show=\'$ctrl.title && $ctrl.title.length\' ng-bind=\'$ctrl.title\'></span>\n            <div class=\'frizzly-modal-close\' ng-click=\'$ctrl.hideModal()\'>\n                <div>\n                    <span class=\'frizzly-modal-close-x\'>X</span>\n                </div>\n            </div>\n            <div class=\'frizzly-modal-dialog-content\' ng-transclude></div>\n        </div>\n    </div>\n  '
};
exports.default = ModalComponent;

},{"./modal.controller":44}],44:[function(require,module,exports){
"use strict";
...
},{"./navbar.component":46,"angular":60}],46:[function(require,module,exports){
'use strict';
...
var NavbarComponent = {
    ...
    template: '\n    <h2 class="nav-tab-wrapper">\n        <a ng-repeat="tab in $ctrl.tabs" \n            href="?page={{ $ctrl.page }}&tab={{ tab.slug }}" class="nav-tab {{ $ctrl.tab == tab.slug ? \'nav-tab-active\' : \'\'  }}">\n            {{ tab.name }}\n        </a>\n        <a ng-repeat="link in $ctrl.links" href="{{ link.url }}" class="nav-tab" target="_blank">\n            {{ link.name }}\n        </a>\n    </h2>\n  '
};
...
var status = _angular2.default.module('status', []).component('status', _status2.default).name;

exports.default = status;

},{"./status.component":48,"angular":60}],48:[function(require,module,exports){
'use strict';
...
var _status = require('./status.controller');
...
},{"./status.controller":49}],49:[function(require,module,exports){
'use strict';
...
var StatusController = function () {
    function StatusController($anchorScroll, httpService) {
        var _this = this;
        ...
        httpService.onRequest(function () {
            return _this.onRequestHandler();
        });
        httpService.onResponse(function (_ref) {
            var status = _ref.status;
            return _this.onResponseHandler(status);
        });
    }

    _createClass(StatusController, [{
        key: 'onResponseHandler',
        value: function onResponseHandler(status) {
            this.status = status;
        }
    }, {
        key: 'onRequestHandler',
        value: function onRequestHandler() {
            this.$anchorScroll();
            this.status.status = 'PENDING';
            this.status.messages = { pending: this.i18n.pending };
        }
    }]);
...
StatusController.$inject = ['$anchorScroll', 'httpService'];
    ...
    _createClass(HttpService, [{
        ...
        value: function init(config) {
            ...
            this.customActionParams = {
                ...
                nonce: config.customActionNonce
            };
        }
    }, {
        key: 'onRequest',
        value: function onRequest(func) {
            this.requestObservers.push(func);
        }
    }, {
        key: 'onResponse',
        value: function onResponse(func) {
            this.responseObservers.push(func);
        }
    }, {
        key: 'customAction',
        value: function customAction(name, settings) {
            var params = _angular2.default.extend({}, this.customActionParams, { name: name, settings: settings });
            return this.processRequest(params);
        }
    }, {
        key: 'processRequest',
        value: function processRequest(params) {
            var _this = this;
            ...
            this.requestObservers.forEach(function (observer) {
                observer();
            });

            return this.$http(requestArgs).then(function (_ref) {
                var data = _ref.data;

                _this.responseObservers.forEach(function (observer) {
                    observer(data);
                });
                return data;
            });
...
},{"angular":60}],51:[function(require,module,exports){
'use strict';
...
var _http = require('./http.service');
...
var services = _angular2.default.module('services', []).service('httpService', _http2.default).service('linkService', _link2.default).name;

exports.default = services;

},{"./http.service":50,"./link.service":52,"angular":60}],52:[function(require,module,exports){
'use strict';
...
},{"./app/app":3,"angular":60,"angular-drag-and-drop-lists":54}],54:[function(require,module,exports){
...
},{"./angular-sanitize":55}],57:[function(require,module,exports){
(function withAngular(angular, window) {
  ...
  , tooltipDirective =  ['$log', '$http', '$compile', '$timeout', '$controller', '$injector', 'tooltipsConf', '$templateCache', function tooltipDirective($log, $http, $compile, $timeout, $controller, $injector, tooltipsConf, $templateCache) {
...
},{"./dist/angular-tooltips":57}],59:[function(require,module,exports){
